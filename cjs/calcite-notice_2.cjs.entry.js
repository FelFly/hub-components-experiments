...
const CalciteNotice = class {
    ...
    render() {
        ...
        const closeButton = (index.h("button", { class: "notice-close", "aria-label": "close", onClick: () => this.close(), ref: (el) => (this.closeButton = el) }, index.h("calcite-icon", { icon: "x", scale: "m" })));
        return (index.h(index.Host, { active: this.active, dir: dir }, this.icon ? this.setIcon() : null, index.h("div", { class: "notice-content" }, index.h("slot", { name: "notice-title" }), index.h("slot", { name: "notice-message" }), index.h("slot", { name: "notice-link" })), this.dismissible ? closeButton : null));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
    ...
    setIcon() {
        ...
        return (index.h("div", { class: "notice-icon" }, index.h("calcite-icon", { icon: path, scale: "m" })));
    }
...
const HubMetadataEditor = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("metadata-form", { sections: ["arcgis"], resource: this.resource }), index.h("calcite-button", { onClick: (event) => this.saveForm(event) }, "Save Info")));
    }
};
