...
const CalcitePopover = class {
    ...
    renderCloseButton() {
        ...
        return closeButton ? (index.h("button", { ref: (closeButtonEl) => (this.closeButtonEl = closeButtonEl), "aria-label": textClose, title: textClose, class: { [resources.CSS.closeButton]: true }, onClick: this.hide }, index.h("calcite-icon", { icon: "x", scale: "m" }))) : null;
    }
    render() {
        ...
        return (index.h(index.Host, { role: "dialog", class: {
            ...
            }, "aria-hidden": !displayed ? "true" : "false", id: this.getId() }, arrowNode, index.h("div", { class: resources.CSS.container }, this.renderImage(), index.h("div", { class: resources.CSS.content }, index.h("slot", null), this.renderCloseButton()))));
    }
