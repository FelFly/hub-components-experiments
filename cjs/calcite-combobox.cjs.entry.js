...
const CalciteCombobox = class {
    ...
    handleInputKeyDown(event) {
        if (event.target === this.textInput) {
            ...
            if (event.shiftKey && key$1 === "Tab") {
                return;
            }
            else if (key$1 === "Escape") {
                this.active = false;
            }
            else if (key$1 === "ArrowDown") {
                this.focusFirstItem();
            }
    ...
    calciteComboboxItemKeyEventHandler(event) {
        ...
        const keyCode = key.getKey(keyboardEvent.key);
        switch (keyCode) {
            case "Tab":
    ...
    render() {
        ...
        return (index.h(index.Host, { active: this.active, onFocusin: this.comboboxFocusHandler, onFocusout: this.comboboxFocusHandler, dir: dir }, index.h("div", { class: "selections" }, this.selectedItems.map((item) => {
            return (index.h("calcite-chip", { key: item.value, scale: this.scale, value: item.value, dir: dir, dismissible: true }, item.textLabel));
        })), index.h("div", { role: "combobox", "aria-expanded": this.active.toString(), "aria-owns": listBoxId, "aria-haspopup": "listbox" }, index.h("input", { type: "text", placeholder: this.placeholder, "aria-label": this.label, "aria-autocomplete": "list", "aria-controls": listBoxId, onInput: this.inputHandler, disabled: this.disabled, onKeyDown: (e) => this.handleInputKeyDown(e), ref: (el) => (this.textInput = el) })), index.h("ul", { id: listBoxId, role: "listbox", class: { list: true }, "aria-multiselectable": "true" }, index.h("slot", null))));
    }
