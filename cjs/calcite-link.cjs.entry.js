...
const CalciteLink = class {
    ...
    render() {
        ...
        const iconEl = (index.h("calcite-icon", { class: "calcite-link--icon", icon: this.icon, scale: "s" }));
        return (index.h(index.Host, { dir: dir }, index.h(Tag, Object.assign({}, attributes, { role: role, tabindex: tabIndex, ref: (el) => (this.childEl = el) }), this.icon && this.iconPosition === "start" ? iconEl : null, index.h("slot", null), this.icon && this.iconPosition === "end" ? iconEl : null)));
    }
    //--------------------------------------------------------------------------
    //
    //  Public Methods
