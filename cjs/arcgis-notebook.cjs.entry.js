...
const Notebook = class {
    ...
    // } 
    render() {
        return (index.h(index.Host, null, index.h("h3", { id: "notebook-title", ref: (el) => this.titleEl = el }), index.h("span", { class: "notebook-title" }, index.h("slot", { name: "title" })), index.h("hub-button", { class: "notebook-copy-button", color: "dark", text: "Copy Notebook", action: this.onCopy }), index.h("iframe", { src: "", id: "notebook-iframe", ref: (el) => this.iFrameEl = el })));
    }
};
Notebook.style = arcgisNotebookCss;

exports.arcgis_notebook = Notebook;
