...
import { H as HubType, V as VisibilityOptions } from './hub-content-466c4acb.js';
...
import { s as search } from './hub-search-2272c989.js';
...
function getMemberEvents(authentication) {
    return __awaiter(this, void 0, void 0, function () {
        var groups, eventGroups, portal, eventServiceUrl, searchOptions, eventFeatures, events;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, searchGroups({
...
function searchMemberComments(username, authentication) {
    return __awaiter(this, void 0, void 0, function () {
        var query, portal, annotationsUrl, annotations, _a_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    query = ["1=1"];
...
function searchMemberContent(username, authentication) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, search({ owner: username,
                        authentication: authentication
                    })];
                case 1:
                    content = _b.sent();
