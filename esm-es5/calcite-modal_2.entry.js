...
var CalciteModal = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Host, { dir: dir, role: "dialog", "aria-modal": "true", class: { "is-active": this.isActive } }, h("calcite-scrim", { class: "scrim", theme: "dark" }), h("div", { class: "modal" }, h("div", { "data-focus-fence": "true", tabindex: "0", onFocus: this.focusLastElement.bind(this) }), h("div", { class: "modal__header" }, h("button", { class: "modal__close", "aria-label": this.closeLabel, ref: function (el) { return (_this.closeButton = el); }, onClick: function () { return _this.close(); } }, h("calcite-icon", { icon: "x", scale: "l" })), h("header", { class: "modal__title" }, h("slot", { name: "header" }))), h("div", { class: {
                modal__content: true,
...
var CalciteScrim = /** @class */ (function () {
    ...
    CalciteScrim.prototype.render = function () {
        var loaderNode = this.loading ? (h("calcite-loader", { "is-active": true })) : null;
...
export { CalciteModal as calcite_modal, CalciteScrim as calcite_scrim };
