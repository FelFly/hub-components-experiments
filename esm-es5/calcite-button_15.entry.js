...
import { r as registerInstance, h, H as Host, g as getElement, c as createEvent, d as getAssetPath } from './index-12d3ca5e.js';
import { g as getElementDir, n as nodeListToArray, a as getSlottedElements } from './dom-6f055170.js';
import { g as getKey } from './key-f3fb1af9.js';
import { g as guid } from './guid-7c4316c8.js';
import './index-21611a9b.js';
import { g as getContent, H as HubType } from './hub-content-6d5c424f.js';
...
import { s as search$1 } from './hub-search-b11c77ce.js';
...
import { s as searchMembers, a as searchTeams } from './hub-team-af135992.js';
...
var CalciteButton = /** @class */ (function () {
    ...
    class_1.prototype.connectedCallback = function () {
        // prop validations
        var appearance = ["solid", "outline", "clear", "transparent"];
    ...
    class_1.prototype.render = function () {
        ...
        var loader = (h("div", { class: "calcite-button--loader" }, h("calcite-loader", { "is-active": true, inline: true })));
        var iconScale = this.scale === "l" ? "m" : "s";
        var iconEl = (h("calcite-icon", { class: "calcite-button--icon", icon: this.icon, scale: iconScale }));
        return (h(Host, { hasText: this.hasText, dir: dir }, h(Tag, Object.assign({}, attributes, { onClick: function (e) { return _this.handleClick(e); }, disabled: this.disabled, tabIndex: this.disabled ? -1 : null, ref: function (el) { return (_this.childEl = el); } }), this.loading ? loader : null, this.icon && this.iconPosition === "start" ? iconEl : null, h("slot", null), this.icon && this.iconPosition === "end" ? iconEl : null)));
    };
    //--------------------------------------------------------------------------
    //
    //  Public Methods
...
var CalciteIcon = /** @class */ (function () {
    ...
    class_2.prototype.render = function () {
        ...
        return (h(Host, { "aria-label": semantic ? textLabel : null, role: semantic ? "img" : null }, h("svg", { class: (_a = {},
                _a[CSS$1.mirrored] = dir === "rtl" && mirrored,
                _a.svg = true,
...
var HubGallery = /** @class */ (function () {
    ...
    class_4.prototype.updateGallery = function (query, customParams) {
        return __awaiter(this, void 0, void 0, function () {
            var auth, _a, teams, members, searchParams, results;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
...
var HubMap = /** @class */ (function () {
    ...
    function HubMap(hostRef) {
        ...
        esriLoader_3(["esri/Map"], this.esriMapOptions).then(function (_a) {
            var EsriMap = _a[0];
    ...
    HubMap.prototype.createEsriMapView = function () {
        var _this = this;
        return esriLoader_3(["esri/WebMap", "esri/views/MapView"], this.esriMapOptions).then(function (_a) {
            var WebMap = _a[0], MapView = _a[1];
    ...
    HubMap.prototype.addGeometry = function (geometry) {
        ...
        esriLoader_3(["esri/Graphic",
            "esri/layers/GraphicsLayer"]).then(function (_a) {
    ...
    HubMap.prototype.addSketch = function () {
        ...
        esriLoader_3(["esri/widgets/Sketch",
            "esri/layers/GraphicsLayer"]).then(function (_a) {
            var Sketch = _a[0], GraphicsLayer = _a[1];
...
var HubRadar = /** @class */ (function () {
    ...
    HubRadar.prototype.componentDidLoad = function () {
        ...
        getMap(this.webmap).then(function (_a) {
            var mapItem = _a[0], mapItemData = _a[1];
...
function computeScore(pattern, _a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.errors, errors = _c === void 0 ? 0 : _c, _d = _b.currentLocation, currentLocation = _d === void 0 ? 0 : _d, _e = _b.expectedLocation, expectedLocation = _e === void 0 ? 0 : _e, _f = _b.distance, distance = _f === void 0 ? Config.distance : _f;
...
// Machine word size
var MAX_BITS = 32;
function search(text, pattern, patternAlphabet, _a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.location, location = _c === void 0 ? Config.location : _c, _d = _b.distance, distance = _d === void 0 ? Config.distance : _d, _e = _b.threshold, threshold = _e === void 0 ? Config.threshold : _e, _f = _b.findAllMatches, findAllMatches = _f === void 0 ? Config.findAllMatches : _f, _g = _b.minMatchCharLength, minMatchCharLength = _g === void 0 ? Config.minMatchCharLength : _g, _h = _b.includeMatches, includeMatches = _h === void 0 ? Config.includeMatches : _h;
...
var BitapSearch = /** @class */ (function () {
    function BitapSearch(pattern, _a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.location, location = _c === void 0 ? Config.location : _c, _d = _b.threshold, threshold = _d === void 0 ? Config.threshold : _d, _e = _b.distance, distance = _e === void 0 ? Config.distance : _e, _f = _b.includeMatches, includeMatches = _f === void 0 ? Config.includeMatches : _f, _g = _b.findAllMatches, findAllMatches = _g === void 0 ? Config.findAllMatches : _g, _h = _b.minMatchCharLength, minMatchCharLength = _h === void 0 ? Config.minMatchCharLength : _h, _j = _b.isCaseSensitive, isCaseSensitive = _j === void 0 ? Config.isCaseSensitive : _j;
        this.options = {
            location: location,
            threshold: threshold,
            distance: distance,
    ...
    BitapSearch.prototype.searchInString = function (text) {
        var _a = this.options, isCaseSensitive = _a.isCaseSensitive, includeMatches = _a.includeMatches;
        if (!isCaseSensitive) {
        ...
        var _b = this.options, location = _b.location, distance = _b.distance, threshold = _b.threshold, findAllMatches = _b.findAllMatches, minMatchCharLength = _b.minMatchCharLength;
        var allMatchedIndices = [];
        var totalScore = 0;
        var hasMatches = false;
        for (var i = 0, len = this.chunks.length; i < len; i += 1) {
            var _c = this.chunks[i], pattern = _c.pattern, alphabet = _c.alphabet;
...
var FuzzyMatch = /** @class */ (function (_super) {
    ...
    function FuzzyMatch(pattern, _a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.location, location = _c === void 0 ? Config.location : _c, _d = _b.threshold, threshold = _d === void 0 ? Config.threshold : _d, _e = _b.distance, distance = _e === void 0 ? Config.distance : _e, _f = _b.includeMatches, includeMatches = _f === void 0 ? Config.includeMatches : _f, _g = _b.findAllMatches, findAllMatches = _g === void 0 ? Config.findAllMatches : _g, _h = _b.minMatchCharLength, minMatchCharLength = _h === void 0 ? Config.minMatchCharLength : _h, _j = _b.isCaseSensitive, isCaseSensitive = _j === void 0 ? Config.isCaseSensitive : _j;
...
var ExtendedSearch = /** @class */ (function () {
    function ExtendedSearch(pattern, _a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.isCaseSensitive, isCaseSensitive = _c === void 0 ? Config.isCaseSensitive : _c, _d = _b.includeMatches, includeMatches = _d === void 0 ? Config.includeMatches : _d, _e = _b.minMatchCharLength, minMatchCharLength = _e === void 0 ? Config.minMatchCharLength : _e, _f = _b.findAllMatches, findAllMatches = _f === void 0 ? Config.findAllMatches : _f, _g = _b.location, location = _g === void 0 ? Config.location : _g, _h = _b.threshold, threshold = _h === void 0 ? Config.threshold : _h, _j = _b.distance, distance = _j === void 0 ? Config.distance : _j;
        this.query = null;
        this.options = {
            isCaseSensitive: isCaseSensitive,
            includeMatches: includeMatches,
    ...
    ExtendedSearch.prototype.searchIn = function (value) {
        ...
        var text = value.$;
        var _a = this.options, includeMatches = _a.includeMatches, isCaseSensitive = _a.isCaseSensitive;
        ...
        for (var i = 0, qLen = query.length; i < qLen; i += 1) {
            ...
            for (var j = 0, pLen = searchers_1.length; j < pLen; j += 1) {
                ...
                var _b = searcher.search(text), isMatch = _b.isMatch, matchedIndices = _b.matchedIndices, score = _b.score;
                if (isMatch) {
                    numMatches += 1;
                    totalScore += score;
                    if (includeMatches) {
...
var SPACE = /[^ ]+/g;
function createIndex(keys, list, _a) {
    var _b = (_a === void 0 ? {} : _a).getFn, getFn = _b === void 0 ? Config.getFn : _b;
    var indexedList = [];
        ...
        for (var i = 0, len = list.length; i < len; i += 1) {
            ...
            for (var j = 0; j < keysLen; j += 1) {
                ...
                if (isArray(value)) {
                    ...
                    while (stack.length) {
                        var _c = stack.pop(), arrayIndex = _c.arrayIndex, value_1 = _c.value;
...
var Fuse = /** @class */ (function () {
    ...
    Fuse.prototype._searchUsing = function (searcher) {
        ...
        if (this.listIsStringArray) {
            ...
            for (var i = 0, len = list.length; i < len; i += 1) {
                var _a = list[i], item = _a.$, idx = _a.idx;
                if (!isDefined(item)) {
                    continue;
                }
                var matches = [];
    ...
    Fuse.prototype._format = function (results) {
        var finalOutput = [];
        var _a = this.options, includeMatches = _a.includeMatches, includeScore = _a.includeScore;
        var transformers = [];
        if (includeMatches)
...
export { CalciteButton as calcite_button, CalciteCard as calcite_card, CalciteCheckbox as calcite_checkbox, CalciteIcon as calcite_icon, CalciteLoader as calcite_loader, CalciteTree as calcite_tree, CalciteTreeItem as calcite_tree_item, HubCard as hub_card, HubContentCard as hub_content_card, HubFilterCategory as hub_filter_category, HubGallery as hub_gallery, HubInput as hub_input, HubMap as hub_map, HubRadar as hub_radar, HubSuggestInput as hub_suggest_input };
