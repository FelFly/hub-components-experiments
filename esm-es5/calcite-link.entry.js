...
var CalciteLink = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        var tabIndex = this.childElType === "span" ? 0 : null;
        var iconEl = (h("calcite-icon", { class: "calcite-link--icon", icon: this.icon, scale: "s" }));
        return (h(Host, { dir: dir }, h(Tag, Object.assign({}, attributes, { role: role, tabindex: tabIndex, ref: function (el) { return (_this.childEl = el); } }), this.icon && this.iconPosition === "start" ? iconEl : null, h("slot", null), this.icon && this.iconPosition === "end" ? iconEl : null)));
    };
    //--------------------------------------------------------------------------
    //
    //  Public Methods
