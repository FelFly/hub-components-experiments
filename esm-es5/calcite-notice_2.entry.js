...
import { u as updateContent } from './hub-content-6d5c424f.js';
...
var HubMetadataEditor = /** @class */ (function () {
    ...
    HubMetadataEditor.prototype.render = function () {
        var _this = this;
        return (h(Host, null, h("metadata-form", { sections: ["arcgis"], resource: this.resource }), h("calcite-button", { onClick: function (event) { return _this.saveForm(event); } }, "Save Info")));
    };
