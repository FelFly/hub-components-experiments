...
var Notebook = /** @class */ (function () {
    ...
    Notebook.prototype.componentDidLoad = function () {
        var _this = this;
        if (this.view == "edit") {
            this.getEdit();
        }
    ...
    Notebook.prototype.getEdit = function () {
    ...
    Notebook.prototype.getPreview = function () {
        var _this = this;
    ...
    Notebook.prototype.onCopy = function (_e) {
        var _this = this;
    ...
    Notebook.prototype.copyNotebook = function () {
    ...
    Notebook.prototype.render = function () {
        var _this = this;
        return (h(Host, null, h("h3", { id: "notebook-title", ref: function (el) { return _this.titleEl = el; } }), h("span", { class: "notebook-title" }, h("slot", { name: "title" })), h("hub-button", { class: "notebook-copy-button", color: "dark", text: "Copy Notebook", action: this.onCopy }), h("iframe", { src: "", id: "notebook-iframe", ref: function (el) { return _this.iFrameEl = el; } })));
    };
    return Notebook;
}());
