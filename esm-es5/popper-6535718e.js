...
function getScrollParent(node) {
    ...
    if (isHTMLElement(node)) {
        ...
        var _getComputedStyle = getComputedStyle(node), overflow = _getComputedStyle.overflow, overflowX = _getComputedStyle.overflowX, overflowY = _getComputedStyle.overflowY;
...
function createPopper$1(_a) {
    var referenceEl = _a.referenceEl, el = _a.el, open = _a.open, placement = _a.placement, modifiers = _a.modifiers;
    if (!referenceEl || !open) {
        return null;
    }
...
function updatePopper(_a) {
    var el = _a.el, modifiers = _a.modifiers, calcitePlacement = _a.placement, popper = _a.popper;
    var placement = getPlacement(el, calcitePlacement);
    popper.setOptions({
        modifiers: modifiers,
        placement: placement
    });
